const API_ROOT = "http://www.cwzp990.top:3000";
...
export const CategoryHotPlaylist = API_ROOT.concat(
  apiMusic.categoryHotPlaylist
);
...
export const PlaylistCommentResource = API_ROOT.concat(
  apiMusic.playlistComment
);
